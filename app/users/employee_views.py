...
class CreateEmployee(graphene.Mutation):
    ...
    def mutate(self, info, first_name, last_name, email, phone, password, job_title, job_description, contract_type):
        if Employee.objects.filter(email=email).exists():
            raise Exception('Email already registered.')

        employee = Employee(first_name=first_name, last_name=last_name, email=email, phone=phone, job_title=job_title,
...
class UpdateEmployee(graphene.Mutation):
    ...
    def mutate(self, info, IM, first_name=None, last_name=None, email=None, phone=None, password=None, job_title=None,
